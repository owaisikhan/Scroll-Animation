...
const SCRIPT: { id: string; state: Keyframe }[] = [
  ...
  { id: "intro", state: { stage: 0, x: -1.4, y: 0, scale: 1.5, spread: 0.05 } },
  // Still a brain, now scaled up until it fills the screen behind the copy.
  { id: "m1", state: { stage: 0, x: 0, scale: 2.2, spread: 0.12 } },
  // Only now does it start to come apart.
  { id: "m2", state: { stage: 0.75, x: 0, scale: 2.3, spread: 0.6, breath: 1.5 } },
